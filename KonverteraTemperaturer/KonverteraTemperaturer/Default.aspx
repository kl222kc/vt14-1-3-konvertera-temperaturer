...
<body>
    ...
    <div>
        ...
        <div>
            <asp:Label ID="IncreaseTempLabel" runat="server" Text="Temperatursteg:"></asp:Label>
        ...
        <asp:RadioButton ID="ConvertCelRadio" runat="server" GroupName="ConvertType" Text="Celsius till Fahrenheit" Checked="true" />
        <asp:RadioButton ID="ConvertFarRadio" runat="server" GroupName="ConvertType" Text="Fahrenheit till Celsius" />
